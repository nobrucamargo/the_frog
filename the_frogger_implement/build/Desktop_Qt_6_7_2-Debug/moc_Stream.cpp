...
struct qt_meta_stringdata_CLASSStreamENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSStreamENDCLASS = QtMocHelpers::stringData(
    "Stream",
    "spawnNpc",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSStreamENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Stream::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSStreamENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSStreamENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSStreamENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Stream::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSStreamENDCLASS.stringdata0))
